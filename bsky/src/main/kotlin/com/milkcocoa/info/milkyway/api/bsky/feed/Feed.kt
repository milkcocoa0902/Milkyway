...
class Feed(
    ...
    suspend fun getFeedGenerator(request: GetFeedGenerator.GetFeedGeneratorRequest) = GetFeedGenerator(domain).execute(request)
    suspend fun getFeedGenerators(request: GetFeedGenerators.GetFeedGeneratorsRequest) = GetFeedGenerators(domain).execute(request)
    ...
    suspend fun getSuggestedFeeds(request: GetSuggestedFeeds.GetSuggestedFeedsRequest) = GetSuggestedFeeds(domain).execute(request)
