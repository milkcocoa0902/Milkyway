...
import com.milkcocoa.info.milkyway.api.bsky.feed.GetActorFeeds
import com.milkcocoa.info.milkyway.api.bsky.feed.GetActorLikes
import com.milkcocoa.info.milkyway.api.bsky.feed.GetAuthorFeed
...
class Actor(
    ...
    suspend fun searchActorsTypeahead(request: SearchActorsTypeAhead.SearchActorsTypeAheadRequest) = SearchActorsTypeAhead(domain).execute(request)
